...
import { OverlayTrigger, Tooltip, Button, ToggleButton, ButtonGroup } from 'react-bootstrap'

import { colorScheme, status as taskStatus } from './defaultValues'
...
const Toolbar = ({ self, status, onNavigate, label, setSelf, setStatus }) => {
